...
#ifdef 		EC_16X_PLL 									//EC 16x PLL = (24 MIPS)    using a 6 MHz EC oscillator                         
...
// 32 Bit timers 2/3 and 4/5
#define TIMER_32_COUNT_1S 	   	24000000				// 1 second count for 32-Bit timer period register  with 1:1 Prescalar
#define TIMER_32_COUNT_1MS   	23866					// 1 milli-second count for 32-Bit timer period register with 1:1 Prescalar
#define TIMER_32_COUNT_US 	   	24						// 1 micro-second count for 32-Bit timer period register with 1:1 Prescalar
...
unsigned int             TimerCount0 = 0;                  // Timer interrupt 0 count (Seconds)
unsigned int             TimerCount1 = 0;                  // Timer interrupt 1 count (Seconds)
unsigned int             TimerCount2 = 0;                  // Timer interrupt 2 count (Milliseconds)
unsigned int             TimerCount3 = 0;                  // Timer interrupt 3 count 
unsigned int             TimerCount4 = 0;                  // Timer interrupt 4 count (Microseconds)
unsigned int             TimerCount5 = 0;                  // Timer interrupt 5 count

unsigned int             Hours = 0;                        // Hours counter
unsigned int             Minutes = 0;                      // Minutes counter
...
void            SetupTimers(void)
{
    ...
    TimerCount4 = 0;                                       // Reset Timer Interrupt 3 count
    TimerCount5 = 0;                                       // Reset Timer Interrupt 3 count
...
void            ProcessTimer2(void)
{
    ...
    LED_2 = ~LED_2;                                          // Toggle the Timer 2 LED
                                                           // interrupt LED indicator
...
void            ProcessTimer3(void)
{
    ...
    LED_3 = ~LED_3;                                          // Toggle the Timer 3 LED
                                                           // interrupt LED indicator
