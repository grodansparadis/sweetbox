...
extern volatile byte RingBuffer[];                      // Ring Buffer for incomming data from serial port (USART)
...
void 		InitializeUart1(void);                     // Initializes the UART 1
void 		InitializeUart2(void);                     // Initializes the UART 2
