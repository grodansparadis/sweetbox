...
#ifdef __LPC2103_H
#define SPI_IODIR      FIODIR

/* only needed during init: */
#define SELECT_CARD()   FIOCLR = (1<<SPI_SS_PIN)
#define UNSELECT_CARD()	FIOSET = (1<<SPI_SS_PIN)
...
*/
	...
	//#define IOMAN_NUMBUFFER 2 /* 8KB RAM on the LPC2103 - let's use 1 kB */
